...
Contact: gita82tripathi@gmail.com`,
            ...
            console.log(`[OTP FOR TESTING] ${email}: ${otp}`); // Display OTP in console for testing
            return { success: true, message: 'OTP sent successfully', otp: otp }; // Include OTP in response for testing
